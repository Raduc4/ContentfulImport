...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.17.0"}`, params.application, params.integration, params.feature);
...
function _pollBulkActionStatus() {
  _pollBulkActionStatus = _asyncToGenerator(function* (getBulkActionFunction, options) {
    ...
    yield delay__WEBPACK_IMPORTED_MODULE_0___default()(initialDelayMs);
    ...
    while (retryCount < maxRetries && !done) {
      ...
      yield delay__WEBPACK_IMPORTED_MODULE_0___default()(retryIntervalMs);
      retryCount += 1;
    }
